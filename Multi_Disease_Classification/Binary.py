...
plt.savefig(r"/Users/user/Downloads/Disease_PCA.png", dpi=1200); plt.close()
...
plt.title("Combined ROC Curve (Disease)")
plt.legend(loc="lower right"); plt.grid(True); plt.tight_layout()
plt.savefig(r"/Users/user/Downloads/Disease_Combined_ROC_all_models.png", dpi=1200)
plt.show()
...
metrics_df.to_csv(r"/Users/user/Downloads/Disease_model_metrics_oof.csv", index=False)
